...
@Slf4j
@Component
@RocketMQMessageListener(consumerGroup = "consumer-group", topic = "add-bonus", selectorExpression = "tagStr")
public class OrderPaySuessusServerImpl2 implements RocketMQListener<String> {
